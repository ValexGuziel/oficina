...
<head>
    ...
    <style>
        ...
        .os-details p strong {
            ...
            width: 150px; /* Ajuste conforme necessário para alinhar os dois pontos */
        }
        .status-aberta { color: #dc3545; font-weight: bold; }
        .status-em-andamento { color: #deac15ff; font-weight: bold; }
        .status-concluída { color: #40b82bff; font-weight: bold; }
        .status-aguardando-pecas { color: #3c2374ff; font-weight: bold; }
...
<body>
    ...
    <?php if ($os_data): ?>
        <div class="os-details">
            ...
            <p><strong>Descrição do Problema:</strong> <?php echo nl2br(htmlspecialchars($os_data['descricao_problema'])); ?></p>
            <p>
            ...
            <p><strong>Data de Conclusão:</strong> <?php echo $os_data['data_conclusao'] ? date('d/m/Y H:i', strtotime($os_data['data_conclusao'])) : 'N/A'; ?></p>
